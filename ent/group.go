...
type Group struct {
	config `json:"-"`
	// ID of the ent.
	ID schema.GroupId `json:"id,omitempty"`
...
func (*Group) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case group.FieldUniqueName, group.FieldName:
...
func (gr *Group) String() string {
	...
	builder.WriteString(gr.UniqueName)
