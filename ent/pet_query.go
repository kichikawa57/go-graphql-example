...
func (pq *PetQuery) FirstID(ctx context.Context) (id schema.PetId, err error) {
	var ids []schema.PetId
...
func (pq *PetQuery) FirstIDX(ctx context.Context) schema.PetId {
...
func (pq *PetQuery) OnlyID(ctx context.Context) (id schema.PetId, err error) {
	var ids []schema.PetId
...
func (pq *PetQuery) OnlyIDX(ctx context.Context) schema.PetId {
...
func (pq *PetQuery) IDs(ctx context.Context) ([]schema.PetId, error) {
	var ids []schema.PetId
...
func (pq *PetQuery) IDsX(ctx context.Context) []schema.PetId {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
