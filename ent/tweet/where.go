...
func ID(id uuid.UUID) predicate.Tweet {
...
func IDEQ(id uuid.UUID) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uuid.UUID) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func IDIn(ids ...uuid.UUID) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func IDNotIn(ids ...uuid.UUID) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id uuid.UUID) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func IDGTE(id uuid.UUID) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func IDLT(id uuid.UUID) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func IDLTE(id uuid.UUID) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
...
func TypeEQ(v property.TweetType) predicate.Tweet {
	vc := v
	return predicate.Tweet(func(s *sql.Selector) {
...
func TypeNEQ(v property.TweetType) predicate.Tweet {
	vc := v
	return predicate.Tweet(func(s *sql.Selector) {
...
func TypeIn(vs ...property.TweetType) predicate.Tweet {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TypeNotIn(vs ...property.TweetType) predicate.Tweet {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func HasGoods() predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(GoodsTable, FieldID),
...
func HasGoodsWith(preds ...predicate.Good) predicate.Tweet {
	return predicate.Tweet(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
